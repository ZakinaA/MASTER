<%-- 
    ...
    Created on : 1 oct. 2020, 14:01:45
    Author     : sio2
--%>
    ...
    <body>
        ...
        %>
         ...
         <table class="table table-bordered table-striped table-condensed">
            ...
            <tr><td>NOMBRE DE BOXES :</td><td><%  out.println(unLieu.getNbBoxes());%></td>  </tr>
            <tr><td>COMMENTAIRE :</td><td><%  out.println(unLieu.getCommentaire());%></td>  </tr>
