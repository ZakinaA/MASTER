    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="/MASTER/employee/Accueil">Accueil <span class="sr-only">(current)</span></a>
                    </li>
                    <!-- Item à ajouter
                    <li class="nav-item">
        ...
        <!-- FIN DE LA NAVBAR -->
            ...
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4"><% out.println("Bienvenue, " + session.getAttribute("employee") + "."); %></h1>
                </div>
            </div> 
        ...
        <div class="container">
            ...
            <% for (int i = 0; i < lesCategVentes.size(); i++) {
                ...
                out.println("<a href ='/MASTER/vendeur/ventes?categ="+ uneCategVente.getCode()+"' class='text-decoration-none text-dark'>");
